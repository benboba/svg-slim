...
describe('path/check-sub-paths', () => {
	it('combine normal', () => {
		stringifyPath(doCompute(checkSubPath(doCompute(parsePath('M80 80 A 45 45, 0, 0, 0, 125 125 45 45, 0, 0, 0, 170 80 45 45, 0, 0, 0, 125 35 45 45, 0, 0, 0, 80 80')), false, false, 2, 2))).should.equal('m80,80a45,45,0,0045,45,45,45,0,10-45-45');
		stringifyPath(doCompute(checkSubPath(doCompute(parsePath('M80 80 A 45 45, 0, 0, 0, 125 125 35 35, 0, 0, 0, 170 80 45 45, 0, 0, 0, 125 35 45 45, 0, 0, 0, 80 80')), false, false, 2, 2))).should.equal('m80,80a45,45,0,0045,45,35,35,0,0045-45,45,45,0,00-90,0');
		stringifyPath(doCompute(checkSubPath(doCompute(parsePath('M80 80 A 45 45, 0, 0, 0, 125 125 45 45, 0, 1, 0, 155 80 45 45, 0, 1, 0, 125 35 45 45, 0, 1, 0, 80 80')), false, false, 2, 2))).should.equal('m80,80a45,45,0,0045,45,45,45,0,1030-45,45,45,0,10-30-45,45,45,0,10-45,45');
		stringifyPath(doCompute(checkSubPath(doCompute(parsePath('M3 4 A 5 5, 0, 1, 1, 3 -4 5 5, 0, 0, 1, 5, 0')), false, false, 2, 2))).should.equal('m3,4a5,5,0,112-4');
		stringifyPath(doCompute(checkSubPath(doCompute(parsePath('M3 4 A 5 5, 0, 0, 0, 5, 0 5 5, 0, 1, 0, -3, 4')), false, false, 2, 2))).should.equal('m3,4a5,5,0,10-6,0');
	});
	...
	it('combine rotation', () => {
		stringifyPath(doCompute(checkSubPath(doCompute(parsePath('M80 80 A 45 45, 90, 0, 0, 125 125 45 45, 90, 0, 0, 170 80 45 45, 90, 0, 0, 125 35 45 45, 90, 0, 0, 80 80')), false, false, 2, 2))).should.equal('m80,80a45,45,90,0045,45,45,45,90,10-45-45');
	});

	it('combine rx ry rotation', () => {
		stringifyPath(doCompute(checkSubPath(doCompute(parsePath('M6 4 A 5 10, 90, 1, 1, 6 -4 5 10, 90, 0, 1, 10, 0')), false, false, 2, 2))).should.equal('m6,4a5,10,90,114-4');
	});
	...
	it('check z', () => {
		stringifyPath(doCompute(checkSubPath(doCompute(parsePath('M 0 0z')), false, false, 2, 2))).should.equal('');
	});
