...
describe('rules/shorten-class', () => {
	it('rule false branch', async () => {
		...
		createXML(dom).should.equal('<svg> <style>.thisIsRed { fill: red; } </style> <rect class="thisIsRed" width="100" height="100"/> <rect class="thisIsRed thisIsBlue" width="100" height="100"/> </svg>');
	});
