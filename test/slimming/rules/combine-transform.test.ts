...
describe('rules/combine-transform', () => {
	...
	it('合并 Transform', async () => {
		...
		createXML(dom).should.equal('<svg> <text>1</text> <text transform="scale(4)">2</text> <text transform="matrix(0,1.32-1.32,0,13.2.1)">3</text> <text transform="scale(2,3)">4</text> <text>5</text> <text transform="rotate(-8.97)">6</text> </svg>');
	});
});
