...
describe('rules/shape-to-path', () => {
	...
	it('转换形状为路径', async () => {
		const xml = `<svg>
		<rect fill="red" width="100" height="0.5"/>
		...
		createXML(dom).replace(/>\s+</g, '><').should.equal('<svg><path fill="red" d="M0,0v.5h100v-.5z"/><path d="M0,0h1e3v100h-1e3z"/><rect width="-1000"/><rect height="-100"/><rect rx="5"/><rect ry="5"/><path fill="red" d="M0,0L100,300"/><circle/><polyline/><polygon/><path d="M10,10"/><path fill="red" d="M0,0L100,100,200-200z"/></svg>');
	});
});
