...
describe('rules/compute-path', () => {
	...
	it('重新计算路径', async () => {
		...
		createXML(dom).should.equal('<svg> <path d="M0,0V300v-1"/> <path/> <path d="M5e5.1L0,0H100V100H0z"/> <path d="M80,80a45,45,0,1,0,45-45,45,45,0,0,0-45,45z"/> <path d="M0,0Q0,100,100,100T200,0z"/> <path d="M0,0C50,0,50,100,100,100S150,50,150,0z"/> </svg>');
	});
